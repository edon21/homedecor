...
const ProductItem = () => {
  return (
    <div className='productItem shadow-2xs rounded-md overflow-hidden mb-7'>
      <div className=' group imgWrapper w-[100%] h-[220px] overflow-hidden rounded-md relative'>
        ...
        <div className='info p-3'>
            <h6 className='text-[13px]'>
                <Link to="/product/45545" className='link transition-all'>
                Product Name
                </Link>
            </h6>
            <h3 className='text-[14px] title mt-1 font-[500] mb-1 text-[rgba(0,0,0,0.9)]'>
                <Link to="/product/5454" className='link transition-all'>
